...
public:
	...
	void signal(ID3D12CommandQueue* queue) { queue->Signal(fence, ++value); }
...
public:
	...
	void initialize(HWND hwnd, int _width, int _height) {
		...
		// Create Swap Chain
		// Interfaces can inherit, we might want more features
		// CreateSwapChainForHwnd creates IDXGISwapChain1
		// We cast from IDXGISwapChain1 to IDXGISwapChain3
